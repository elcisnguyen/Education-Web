...
INSERT INTO `general_credential` VALUES ('nndk','TEACHER','$2b$10$UyHDgVMJTBmnvieWcrZkiuca6QCaTved05C0yztjTObLLjOHf5KyC','Ngo Ngoc Dang Khoa','nndk@gmail.com','https://res.cloudinary.com/eduwebcloud/image/upload/v1610470583/ava/noavatar_og91yw.png',0,'OK');
INSERT INTO `general_credential` VALUES ('ntmt','TEACHER','$2b$10$Qq7HBzWnfzJCP9.J4SlmvOttZSvjOtCjSpE4QFTIp9UWY0YmPtl0C','Nguyen Thi Minh Tuyen','ntmt@gmail.com','https://res.cloudinary.com/eduwebcloud/image/upload/v1610470583/ava/noavatar_og91yw.png',0,'OK');
INSERT INTO `general_credential` VALUES ('tad','TEACHER','$2b$10$AV1Zd0hCryhfXSGVf9THGeCA5epFZl/XBko8zaopj3wKe5KHSRtse','Tran Anh Duy','tad@gmail.com','https://res.cloudinary.com/eduwebcloud/image/upload/v1610470583/ava/noavatar_og91yw.png',0,'OK');
INSERT INTO `general_credential` VALUES ('tamphuc','STUDENT','$2b$10$MtjRtxJ2YS9f.N52JUKfW.IgoT1M0jpfKBdp5grxJSve9II/hgFPC','Nguyen Thi Tam Phuc','tamphuc@gmail.com','https://res.cloudinary.com/eduwebcloud/image/upload/v1610470583/ava/noavatar_og91yw.png',0,'OK');
INSERT INTO `general_credential` VALUES ('tanhao','STUDENT','$2b$10$C.wfFb1kxrHd9t4EvfdmmOxreKqhHHMAKF3XzCOxi.4.lWDZYPlDm','Nguyen Tan Hao','tanhao@gmail.com','https://res.cloudinary.com/eduwebcloud/image/upload/v1610470583/ava/noavatar_og91yw.png',0,'OK');
INSERT INTO `general_credential` VALUES ('thanhqng','STUDENT','$2b$10$Kc7e0mNCYul/cDyl7w2.5O61aQHEVj3fv4ujmswtHXpwzmNmZFpka','Nguyen Quy Thanh','quythanh@gmail.com','https://res.cloudinary.com/eduwebcloud/image/upload/v1610470583/ava/noavatar_og91yw.png',0,'OK');
